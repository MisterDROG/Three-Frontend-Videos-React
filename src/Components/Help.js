...
export default function Help() {
    ...
    return (
        <Container className="text-center">
            ...
            <Row className='d-md-flex justify-content-center align-items-center'>
                ...
                <Col sm={6} className='mt-4'>
                    <ul  className="text-start mb-0">
                        ...
                        <li>If you've watched all the videos, just hit randomize at the top and you'll get three random videos from our library.</li>
            ...
            <p>Our site is powered by React and uses React-Bootstrap styles. We use React Router to navigate through pages.</p>
